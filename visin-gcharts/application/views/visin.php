...
var harga=[];
harga['dataStr'] = '<?php echo $harga;?>';        
harga['dataArray'] = JSON.parse(harga['dataStr']);
...
google.charts.setOnLoadCallback(function(){
    ...
    drawChart(pendapatan['dataArray'],'line','pendapatan');
    drawChart(harga['dataArray'],'bar','harga');
...
<div class="uk-container">
    <div class="uk-child-width-1-2@s" uk-grid uk-height-match="target: > div > .uk-card">    
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Pendapatan Bulanan</h3>
                <div id="pendapatan" style="height:350px;"></div>
            </div>
        </div>
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Harga rata-rata per item tertinggi</h3>
                <div id="harga" style="height:350px;"></div>
            </div>
        </div>
</div>
